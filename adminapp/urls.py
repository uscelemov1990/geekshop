...
urlpatterns = [
    ...
    path('users/', admin_views.users, name='users_list'),
    ...
    path('categories/read/', admin_views.categories, name='category_list'),
    ...
    path('products/<int:pk>/', admin_views.products, name='products_list'),
